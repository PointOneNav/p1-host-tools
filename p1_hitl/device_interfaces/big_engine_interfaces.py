        ...
        if self.ssh_client is not None and self.ssh_channel is not None:
            if not self.ssh_channel.exit_status_ready():
                ...
                try:
                    ...
                    # return codes > 128 indicate a signal triggered the termination.
                    # Codes 1,2,9,10,12-15 are signals that may be generated by external sources (SIGHUP, SIGKILL, etc.)

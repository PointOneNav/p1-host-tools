...
class HitlBMWMotoInterface(HitlDeviceInterfaceBase):
    @staticmethod
    ...
    def init_device(self, build_info: Dict[str, Any], skip_reset=False,
        ...
        logger.info(f'Initializing BMW Moto.')
        ...
        tar_filename = "p1_fusion_engine-%s-bmw_moto_mic.tar.gz" % (version_str[len(version_prefix):])
